    ...
    <SafeAreaView className="flex-1 w-full self-stretch bg-gradient-to-br from-[#2ECC71]/5 via-white to-[#2ECC71]/5">
      <ScrollView className="flex-1 w-full" contentContainerStyle={{ flexGrow: 1 }}>
        <View className="flex-1 w-full items-center px-4 py-8">
          ...
          {/* Header */}
            <View className="flex-row items-center gap-3 border-b border-gray-100 px-6 pt-5 pb-4">
            <TouchableOpacity
            ...
            {/* Language */}
              ...
              <View className="mb-3 flex-row items-center gap-3">
                ...
                <View className="inline-flex w-full max-w-xs flex-row rounded-full bg-gray-100 p-1">
                  <TouchableOpacity
                    onPress={() => setLanguage('TR')}
                    className={`flex-1 rounded-full px-4 py-3 font-bold ${
                      language === 'TR' ? 'bg-[#2ECC71] shadow-md' : ''
                    }`}
                  >
                    <Text
                      className={
                        language === 'TR' ? 'text-white text-center' : 'text-gray-600 text-center'
                      }
                    >
                      Turkish (TR)
                    </Text>
                  ...
                  <TouchableOpacity
                    ...
                    className={`flex-1 rounded-full px-4 py-3 font-bold ${
                      language === 'EN' ? 'bg-[#2ECC71] shadow-md' : ''
                    }`}
                  >
                    <Text
                      className={
                        language === 'EN' ? 'text-white text-center' : 'text-gray-600 text-center'
                      }
                    >
                      English (EN)
                    </Text>
            ...
            {/* Dark mode */}
              ...
              <TouchableOpacity
                className={`h-7 w-12 rounded-full p-1 ${
                  darkMode ? 'bg-[#2ECC71]' : 'bg-gray-200'
                }`}
            ...
            {/* Privacy policy */}
              ...
              <View className="items-center pt-4">
                <View className="mb-3 h-16 w-16 items-center justify-center rounded-3xl bg-gradient-to-br from-[#2ECC71] to-[#27AE60] shadow-lg">
