      ...
      <ScrollView className="flex-1 w-full" contentContainerStyle={{ flexGrow: 1 }}>
        <View className="flex-1 w-full items-center px-4 py-8">
          <View className="w-full max-w-sm overflow-hidden rounded-[32px] border-[12px] border-gray-800 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-2xl">
            <View className="flex-row items-center gap-3 border-b border-gray-100 dark:border-gray-700 px-6 pb-4 pt-5">
              <TouchableOpacity
              ...
              <Text className="text-3xl font-black text-gray-900 dark:text-gray-100">Settings</Text>
            </View>
            ...
            <View className="px-6 py-6">
              <View className="mb-6 rounded-3xl border border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/60 p-4">
                <View className="mb-3 flex-row items-center gap-3">
                  ...
                  <View className="flex-1">
                    <Text className="font-bold text-gray-900 dark:text-gray-100">Language</Text>
                    <Text className="text-sm text-gray-500 dark:text-gray-400">Choose your preferred language</Text>
                  </View>
                </View>
                <View className="flex-row rounded-2xl bg-white dark:bg-gray-800 p-1">
                  {(['TR', 'EN'] as const).map((option) => (
                    <TouchableOpacity
                      key={option}
                      className={`flex-1 rounded-2xl px-4 py-3 ${
                        language === option ? 'bg-[#2ECC71]' : 'bg-white dark:bg-gray-800'
                      }`}
                    ...
                    >
                      <Text
                        className={`text-center font-semibold ${
                          language === option ? 'text-white' : 'text-gray-600 dark:text-gray-400'
                        }`}
                      >
              ...
              <View className="mb-6 rounded-3xl border border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/60 p-4">
                <View className="flex-row items-center justify-between gap-4">
                  <View className="flex-1 flex-row items-center gap-3">
                    ...
                    <View className="flex-1">
                      <Text className="font-bold text-gray-900 dark:text-gray-100">Dark Mode</Text>
                      <Text className="text-sm text-gray-500 dark:text-gray-400">Reduce eye strain</Text>
                    </View>
                  </View>
                  <TouchableOpacity
                  ...
                  >
                    <View
                      className={`h-6 w-6 rounded-full bg-white dark:bg-gray-800 ${darkMode ? 'ml-6' : 'ml-0'}`}
                    />
                  </TouchableOpacity>
                </View>
              </View>
              ...
              >
                <View className="flex-row items-center justify-between">
                  <View className="flex-1 flex-row items-center gap-3">
                    ...
                    <View className="flex-1">
                      <Text className="font-bold text-gray-900 dark:text-gray-100">Privacy Policy</Text>
                      <Text className="text-sm text-gray-500 dark:text-gray-400">View our privacy terms</Text>
                    </View>
                  </View>
                  <ChevronRight
                    size={18}
              ...
              {showPrivacyDetails && (
                <View className="mb-6 rounded-3xl border border-purple-100 dark:border-purple-900/40 bg-purple-50 dark:bg-purple-900/20 p-4">
              ...
              <View className="mb-6 rounded-3xl border border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/60 p-4">
                <Text className="mb-2 font-bold text-gray-900 dark:text-gray-100">Current Preferences</Text>
                <Text className="text-sm text-gray-600 dark:text-gray-400">Language: {language}</Text>
              ...
              <View className="items-center pt-4">
                ...
                <Text className="mb-1 text-2xl font-black text-gray-900 dark:text-gray-100">SOZIA</Text>
